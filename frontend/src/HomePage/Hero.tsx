...
const Hero = () => {
    ...
    return (
        <div className="bg-black text-white pt-[8vh] px-4 md:px-8 lg:px-12">
            ...
            {/* Footer */}
            <div className="h-[15px] w-full text-[#414141] flex justify-center items-center tracking-wide font-semibold text-lg md:text-xl border-t border-gray-600 mt-8 py-4 text-center">
